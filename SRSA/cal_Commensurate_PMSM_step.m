...
% Remark : Stepwise response from Fractional-Order Commensurate PMSM system
...
function x_cal=cal_Commensurate_PMSM_step(parameter_a,T_data,Y0,jjj)

x_cal=FO_Commensurate_PMSM_SRSA(parameter_a, T_data,Y0,jjj);