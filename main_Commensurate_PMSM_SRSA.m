...
% Remark : main program: Fractional-Order Commensurate PMSM system
...
for iii=1:Nmax
    ...
    for jjj=1:NT
        x_cal_iden_j=cal_Commensurate_PMSM_step(parameter_a,[Tstart(jjj),Tend(jjj)],[x_cal_start(jjj,1:3),zeros(1,6)]',jjj);
    ...
    for trust=1:Ntr
        ...
        for jjj=1:NT
            x_cal_da_j=cal_Commensurate_PMSM_step(parameter_a,[Tstart(jjj),Tend(jjj)],[x_cal_start(jjj,1:3),zeros(1,6)]',jjj);
